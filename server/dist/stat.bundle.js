...
/***/ function(module, exports, __webpack_require__) {
	...
	//stat.js
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3), __webpack_require__(4), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, _, numeral, HttpUtil) {
	  'use strict';
	  ...
	  StatPage.prototype.draw = function (data) {
	    ...
	    var bubbleChart = new d3.svg.BubbleChart({
	      ...
	      data: {
	        items: data,
	        eval: function _eval(item) {
	          return item.count;
	        },
	        classed: function classed(item) {
